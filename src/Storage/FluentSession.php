...
class FluentSession extends AbstractFluentAdapter implements SessionInterface
{
    ...
    public function get($sessionId)
    {
        /*$result = $this->getConnection()->table('oauth_sessions')
                    ...
                    ->first();*/
        $result = Config::get('couch.client')->useDatabase('oauth_sessions')->getDoc($sessionId);
    ...
    public function create($ownerType, $ownerId, $clientId, $clientRedirectUri = null)
    {
        ...
        Config::get('couch.client')->useDatabase('oauth_sessions');
        $session = Config::get('couch.client')->storeDoc( (object)[
            'client_id' => $clientId,
            'owner_type' => $ownerType,
            'owner_id' => $ownerId,
            'client_redirect_uri' => $clientRedirectUri,
