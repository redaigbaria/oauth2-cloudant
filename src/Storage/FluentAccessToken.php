...
/*        $this->getConnection()->table('oauth_access_tokens')->insert([
        ...
        $client = Config::get('couch.client');
        $client->useDatabase('oauth_access_tokens');
        $client->storeDoc((object)[
                'token' => $token,
                'expire_time' => $expireTime,
                'session_id' => $sessionId,
                'created_at' => Carbon::now(),
    ...
    public function delete(AccessTokenEntity $token)
    {
        ...
        ->delete();*/
        Config::get('couch.client')->useDatabase('oauth_access_tokens')->deleteDoc($token);
    }
}
